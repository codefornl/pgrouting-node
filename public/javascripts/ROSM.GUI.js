ROSM.GUI = {
  init: function() {
    document.getElementById("gui-reset").onclick = function() {
      ROSM.GUI.resetRouting()
    };
    $("#gui-input-source").keyup(function(event) {
      if (event.keyCode == 13) ROSM.GUI.inputChanged("hidden-something", ROSM.C.SOURCE_LABEL, function() {
        ROSM.G.route.reset();
        ROSM.RoutingDescription.reset();
        ROSM.JSON.clear("routing");
      });
    });
    $("#gui-input-target").keyup(function(event) {
      if (event.keyCode == 13) ROSM.GUI.inputChanged("hidden-something", ROSM.C.TARGET_LABEL, function() {
        ROSM.G.route.reset();
        ROSM.RoutingDescription.reset();
        ROSM.JSON.clear("routing");
      });
    });
    $("#gui-input-search").keyup(function(event) {
      if (event.keyCode == 13) ROSM.GUI.inputChanged("search-point-result");
    });
    document.getElementById("gui-input-source").onfocus = function() {
      ROSM.GUI.inputFocus(ROSM.C.SOURCE_LABEL);
    }
    document.getElementById("gui-input-target").onfocus = function() {
      ROSM.GUI.inputFocus(ROSM.C.TARGET_LABEL);
    }
    document.getElementById("gui-reset-source").onclick = function() {
      ROSM.GUI.resetInput(ROSM.C.SOURCE_LABEL);
    }
    document.getElementById("gui-reset-target").onclick = function() {
      ROSM.GUI.resetInput(ROSM.C.TARGET_LABEL);
    }
    document.getElementById("gui-input-search").onclick = function() {
      ROSM.GUI.geocoderCancel();
    }
    document.getElementById("routing").onclick = function() {
      ROSM.GUI.showRouteFunction();
    };
    document.getElementById("search").onclick = function() {
      ROSM.GUI.showSearchFunction();
    };
    document.getElementById("poi").onclick = function() {
      ROSM.GUI.showPOIFunction();
    };
    document.getElementById("hidden-something").style.display = 'none';
    document.getElementById("gui-button-cancel").onclick = function() {
      ROSM.GUI.geocoderCancel();
    };
    document.getElementById("artsEnterainment").onclick = function() {
      ROSM.GUI.checkbox("artsEnterainment");
    };
    document.getElementById("collegeUniversity").onclick = function() {
      ROSM.GUI.checkbox("collegeUniversity");
    };
    document.getElementById("food").onclick = function() {
      ROSM.GUI.checkbox("food");
    };
    document.getElementById("nightLifeSpot").onclick = function() {
      ROSM.GUI.checkbox("nightLifeSpot");
    };
    document.getElementById("outdoorsRecreation").onclick = function() {
      ROSM.GUI.checkbox("outdoorsRecreation");
    };
    document.getElementById("professionalOthersPlaces").onclick = function() {
      ROSM.GUI.checkbox("professionalOthersPlaces");
    };
    document.getElementById("residence").onclick = function() {
      ROSM.GUI.checkbox("residence");
    };
    document.getElementById("shopService").onclick = function() {
      ROSM.GUI.checkbox("shopService");
    };
    document.getElementById("travelTransport").onclick = function() {
      ROSM.GUI.checkbox("travelTransport");
    };
  ...
  showRouteFunction: function() {
    ...
    $('#searchFunction').css({
      left: 0 - $('#searchFunction').width()
    });
    $('#poiFunction').css({
      left: 0 - $('#poiFunction').width()
    });
    $('#routingFunction').stop().animate({
      left: r + 'px'
    }, 300, function() {});
    $('#map').css({
      width: s
  ...
  showSearchFunction: function() {
    ...
    $('#routingFunction').css({
      left: 0 - $('#routingFunction').width()
    });
    $('#poiFunction').css({
      left: 0 - $('#poiFunction').width()
    });
    $('#searchFunction').stop().animate({
      left: r + 'px'
    }, 300, function() {});
    $('#map').css({
      width: s
